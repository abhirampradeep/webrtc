...
class Config {
  ...
  Config({this.videoEnabled= true, this.audioEnabled = true});
}
...
class VideoToggleData {
  ...
  VideoToggleData({this.userId, this.videoEnabled = true});
...
class AudioToggleData {
  ...
  AudioToggleData({this.userId, this.audioEnabled = true});
